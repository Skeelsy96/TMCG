    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-[#1A1A1A]">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <motion.div
          ...
          {/* Headline */}
          <h1 className="text-white mb-6 text-4xl font-bold text-center leading-tight sm:text-5xl lg:text-6xl">Find Your Perfect Mobile Coffee Business
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.6 }} className="mt-12 px-32 flex flex-wrap gap-8">


            <div>
              <div className="text-3xl font-bold text-[#FDD202]">900+</div>
              <div className="text-[#969696] px-2 text-sm">Vans Built</div>
            </div>
            <div>
              <div className="text-[#FDD202] px-6 text-3xl font-bold">19+</div>
              <div className="text-[#969696] text-sm">Years Experience</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-[#FDD202]">Australia</div>
              <div className="text-[#969696] px-3 text-sm">Wide Coverage</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
